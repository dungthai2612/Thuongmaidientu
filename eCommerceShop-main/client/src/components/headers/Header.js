...
const Header = ({ dispatch }) => {
    ...
    return (
        <div className='w-main flex justify-between h-[110px] py-[35px]'>
            ...
            <div className='text-lg  flex text-[13px]'>
                <div className='flex flex-col px-6 border-r items-center'>
                    <span className='flex gap-4 items-center'>
                        <RiPhoneFill color='red' size='small' style={{width: '25px'}} />
                        <span className='font-semibold'> +84 376 000 555 </span>
                    </span>
                    <span>Thứ 2 - Thứ 7 - 9h Sáng - 19h Tối</span>
                </div>
                <div className='flex flex-col items-center px-6 border-r'>
                    <span className='flex gap-4 items-center'>
                        <MdEmail color='red' size='small' style={{width: '25px'}}  />
                        <span className='font-semibold'>Email @digitalworld.com</span>
                    </span>
