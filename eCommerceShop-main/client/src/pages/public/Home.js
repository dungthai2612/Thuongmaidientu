...
const Home = () => {
    ...
    return (
        <div className='w-full '>
            ...
            <div className='my-8 w-main m-auto'>
                <h3 className='text-[20px] font-semibold py-[15px] border-b-2 border-main'>ĐIỂM ĐẾN MỚI</h3>
            ...
            <div className='my-8 w-main m-auto'>
                <h3 className='text-[20px] font-semibold py-[15px] border-b-2 border-main'>BÀI ĐĂNG BLOG</h3>
            </div>
        </div>
    )
}
